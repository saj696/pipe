...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('change', '.cut', function () {
            ...
            var net = parseFloat(obj.closest('tr').find('.net').val());
            if (cut > 0) {
                obj.closest('tr').find('.net').val(net - cut)
            }
        });
        ...
        $(document).on('change', '.over_time', function () {
            ...
            if ((over_time * over_time_rate) > 0) {
                ...
                obj.closest('tr').find('.net').val(total + net)
            }
        });
        ...
        $(document).on('change', '.bonus', function () {
            ...
            var net = parseFloat(obj.closest('tr').find('.net').val());
            if (bonus > 0) {
                obj.closest('tr').find('.net').val(net + bonus)
            }
        });
