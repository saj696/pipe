        ...
        <div class="col-md-12">
            <div class="portlet box yellow">
                <div class="portlet-title">
                    ...
                    <div>
                        <a style="margin: 12px; padding: 5px;" class="label label-success pull-right" href="{{ url('/components/create' )}}">New</a>
                    </div>
                </div>
                    ...
                    <div class="table-scrollable">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="label label-danger" href="{{ url('/components/'.$component->id.'/edit' )}}">Edit</a>
                                </td>
                            </tr>
                            @endforeach
                            @else
