        ...
        <div class="col-md-12">
            <div class="portlet box yellow">
                <div class="portlet-title">
                    ...
                    <div>
                        <a style="margin: 12px; padding: 5px;" class="label label-success pull-right" href="{{ url('/purchases_return/create' )}}">New purchase Return</a>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="label label-info" href="{{ url('/purchase_return/'.$purchase->id )}}">View</a>
                                </td>
                            </tr>
                            @endforeach
                            @else
